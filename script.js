...
function renderGrid() {
  ...
  warblers.forEach((bird, index) => {
    ...
    image.src = `https://gmb6400.github.io/master-detail/images/thumbnails/${slugify(bird.name)}${BIRD_THUMBNAIL_EXTENSION}`;
    image.alt = "";
    image.loading = "lazy";
    ...
    <ul class="food-list">
      ${foods.map((food) => `
        <li class="food-item">
          <img
            class="food-image"
            src="https://gmb6400.github.io/master-detail/images/food/${slugify(food)}${FOOD_IMAGE_EXTENSION}"
            alt=""
            loading="lazy"
            decoding="async"
          >
